    ...
    public static void main(String[] args) {
        ...
        try {
            User registeredUser = authenticationService.register(
                    "username@example.com", "password1111");
            ...
            shoppingCartService.registerNewShoppingCart(loggedInUser);
            ...
            System.out.println("Shopping cart after clearing: "
                    + shoppingCartService.getByUser(loggedInUser));
            ...
            List<Order> orderHistory = orderService.getOrdersHistory(loggedInUser);
            System.out.println("Order history for user: " + orderHistory);
