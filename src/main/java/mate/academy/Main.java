...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException {
        ...
        terminator2.setDescription("An action film about robots war against people. Series 2.");
        ...
        User user = authenticationService.register("ihor.dm.a@gmail.com", "12345678");
