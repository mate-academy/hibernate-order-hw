...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User bob;
        try {
            authenticationService.register("bob_email@gmail.com", "bob_password");
            bob = authenticationService.login("bob_email@gmail.com", "bob_password");
        } catch (RegistrationException e) {
            throw new RuntimeException("Can't register bob", e);
        ...
        System.out.println("Bob shopping cart");
        System.out.println(shoppingCartService.getByUser(bob));

        OrderService orderService = (OrderService) injector.getInstance(OrderService.class);

        System.out.println("create order bob");
        System.out.println(orderService.completeOrder(shoppingCartService.getByUser(bob)));

        System.out.println("get shopping cart after order");
        System.out.println(shoppingCartService.getByUser(bob));

        shoppingCartService.addSession(yesterdayMovieSession, bob);
        shoppingCartService.addSession(tomorrowMovieSession, bob);

        System.out.println("create second order bob");
        System.out.println(orderService.completeOrder(shoppingCartService.getByUser(bob)));

        System.out.println("get shopping cart after second order");
        System.out.println(shoppingCartService.getByUser(bob));

        System.out.println("get history order");
