...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Order orderByVarian = orderService.completeOrder(variansShoppingCart);
        System.out.println(orderByVarian);

        orderService.getOrdersHistory(varian).forEach(System.out::println);
    }
}
