...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        orderService.completeOrder(shoppingCartService.getByUser(userBob));

        shoppingCartService.addSession(yesterdayMovieSession, userBob);
        orderService.completeOrder(shoppingCartService.getByUser(userBob));
        orderService.completeOrder(shoppingCartService.getByUser(userBen));

        List<Order> ordersHistoryBob = orderService.getOrdersHistory(userBob);
        ordersHistoryBob.stream()
