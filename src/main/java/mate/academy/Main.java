...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        authenticationService.register("test6@gmail.com", "sha@1234");
        User user = authenticationService.login("test6@gmail.com", "sha@1234");
        ...
        ordersHistory.forEach(item -> System.out.println(item));
    }
}
