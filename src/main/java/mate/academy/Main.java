...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ShoppingCart userShoppingCart = shoppingCartService.getByUser(bobUser);
        shoppingCartService.clearShoppingCart(shoppingCartService.getByUser(bobUser));

        OrderService orderService = (OrderService) INJECTOR.getInstance(OrderService.class);
        orderService.completeOrder(userShoppingCart);
        orderService.getOrdersHistory(bobUser);
    }
}
