...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Order bobsOrder = orderService.completeOrder(bobShoppingCart);
        System.out.println("Bobs' order was completed " + bobsOrder);

        List<Order> ordersHistory = orderService.getOrdersHistory(userBob);
        System.out.println("Here we get all orders of user Bob " + ordersHistory);
    }
}
