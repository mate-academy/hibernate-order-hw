...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            user2 = authenticationService.register("user2", "1234");
        ...
        List<Order> ordersHistoryByUser1 = orderService.getOrdersHistory(user1);
        List<Order> ordersHistoryByUser2 = orderService.getOrdersHistory(user2);
    }
}
