...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ShoppingCart bobsShoppingCart = shoppingCartService.getByUser(userBob);
        System.out.println(bobsShoppingCart);
        ShoppingCart alicesShoppingCart = shoppingCartService.getByUser(userAlice);
        ...
        bobsShoppingCart = shoppingCartService.getByUser(userBob);
        System.out.println(orderService.completeOrder(bobsShoppingCart));
