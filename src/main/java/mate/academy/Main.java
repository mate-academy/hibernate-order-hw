...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        shoppingCartService.addSession(tomorrowMovieSession, user);
        ShoppingCart shoppingCartByUserSecond = shoppingCartService.getByUser(user);
        Order orderSecond = orderService.completeOrder(shoppingCartByUserSecond);
        System.out.println(orderSecond);
        System.out.println("----------------------------------------------");
        List<Order> ordersHistory = orderService.getOrdersHistory(user);
        for (Order oneOrder : ordersHistory) {
