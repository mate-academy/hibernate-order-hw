...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        authService.register("mail@gmail.com", "qwerty");
        authService.login("mail@gmail.com", "qwerty");

        UserService userService =
                (UserService) INJECTOR.getInstance(UserService.class);
        User user = userService.findByEmail("mail@gmail.com").get();
        ...
        System.out.println("Orders history: " + ordersHistory);
    }
}
