...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        String emailBob = "bob@gmail.com";
        String passwordBob = "SomePassword";

        User userBob = authenticationService.register(emailBob, passwordBob);
        authenticationService.login(emailBob, passwordBob);
