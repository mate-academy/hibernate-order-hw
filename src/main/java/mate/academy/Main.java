...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        CinemaHallService cinemaHallService = (CinemaHallService) instance.getInstance(CinemaHallService.class);
        ...
        ShoppingCart shoppingCartServiceByUser = shoppingCartService.getByUser(loginUser);

        OrderService orderService = (OrderService) instance.getInstance(OrderService.class);

        orderService.completeOrder(shoppingCartServiceByUser);
        orderService.getOrdersHistory(loginUser);
    }
}
