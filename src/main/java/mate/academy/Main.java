...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException, RegistrationException {
        ...
        User mike = authenticationService.register("green.mike@gmail.com", "Dfg123");
        authenticationService.login("green.mike@gmail.com", "Dfg123");

        shoppingCartService.addSession(tomorrowMovieSession, mike);
        System.out.println(shoppingCartService.getByUser(mike));
        orderService.completeOrder(shoppingCartService.getByUser(mike));
    }
}
