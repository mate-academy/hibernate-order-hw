...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User authenticatedBob = null;
        try {
            authenticatedBob = authenticationService.login("bob@gmail.com",
                    "qwerty");
        } catch (AuthenticationException e) {
            throw new RuntimeException("Can't authenticate user Bob", e);
        }
        System.out.println(authenticatedBob);
