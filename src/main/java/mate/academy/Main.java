...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        orderService.completeOrder(shoppingCartUserBob);
        ...
        ShoppingCart shoppingCartUserAlice = shoppingCartService.getByUser(alice);
        orderService.completeOrder(shoppingCartUserAlice);
