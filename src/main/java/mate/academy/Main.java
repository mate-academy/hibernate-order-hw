...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException {
        ...
        Order bobOrder = orderService.completeOrder(bobShoppingCart);
        System.out.println(bobOrder);

        System.out.println("------------------");

        shoppingCartService.addSession(futureMovieSession, bob);
        bobShoppingCart = shoppingCartService.getByUser(bob);
        bobOrder = orderService.completeOrder(bobShoppingCart);
        List<Order> bobsHistory = orderService.getOrdersHistory(bob);
        System.out.println(bobsHistory);
    }
}
