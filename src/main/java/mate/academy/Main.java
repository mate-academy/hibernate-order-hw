...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User mike;
        try {
            bob = authenticationService.register("bob3@gmail.com", "12345");
            mike = authenticationService.register("mikejohsthon@ukr.net", "54321");
        ...
        shoppingCartService.addSession(tomorrowMovieSession, mike);
        shoppingCartService.addSession(tomorrowMovieSession, bob);
        ShoppingCart bobShoppingCart = shoppingCartService.getByUser(bob);
        ShoppingCart mikeShoppingCart = shoppingCartService.getByUser(mike);
        ...
        System.out.println(orderService.completeOrder(mikeShoppingCart));
        System.out.println(orderService.getOrdersHistory(mike));
    }
}
