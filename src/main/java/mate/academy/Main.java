...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        ShoppingCart shoppingCart = shoppingCartService.getByUser(authenticationService
                .register("peter@gmail.com", "P1234"));
        ...
        orderService.completeOrder(shoppingCartService.getByUser(authenticationService
                .login("peter@gmail.com", "P1234")));

        System.out.println(orderService.getOrdersHistory(authenticationService
                .login("peter@gmail.com", "P1234")));
    }
}
