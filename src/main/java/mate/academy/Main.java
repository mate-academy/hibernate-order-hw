...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException {
        ...
        User userA = authenticationService.register("Aaaa@i.ua", "1234");
        User userB = authenticationService.register("Bbbb@i.ua", "qwer");
        System.out.println(authenticationService.login("Bbbb@i.ua", "qwer"));

        ShoppingCartService shoppingCartService = (ShoppingCartService)
                injector.getInstance(ShoppingCartService.class);
        shoppingCartService.addSession(tomorrowMovieSession, userB);
        ShoppingCart shoppingCartByUser = shoppingCartService.getByUser(userB);
