...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        shoppingCartService.addSession(yesterdayMovieSession, ben);
    
        ShoppingCart shoppingCartByBen = shoppingCartService.getByUser(ben);
        
        orderService.completeOrder(shoppingCartByBen);
        for (Order order : orderService.getOrdersHistory(ben)) {
            System.out.println(order);
        }
        System.out.println(shoppingCartByBen);
    }
}
