...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            bob = authenticationService.register("bob@gmail.com", "bob47");
            alex = authenticationService.register("alex@gmail.com", "78945");
        ...
        System.out.println(orderService.completeOrder(alexShoppingCart));
