...
public class Main {
    ...
    static final UserService userService = (UserService) injector
    ...
    public static void main(String[] args) throws RegistrationException {
        ...
        orderService.completeOrder(maxShoppingCart);
        List<Order> maxsOrdersHistory = orderService.getOrdersHistory(max);
        System.out.println(maxsOrdersHistory);
    }
}
