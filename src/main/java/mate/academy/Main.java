...
public class Main {
    public static void main(String[] args) {
        ...
        User bob = null;
        try {
            alice = authenticationService.register("i_am_alice", "my_address");
            bob = authenticationService.register("i_am_bob", "bob1234");
        ...
        Order aliceOrder = orderService.completeOrder(shoppingCartService.getByUser(alice));
