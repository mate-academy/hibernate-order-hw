    ...
    public static void main(String[] args) {
        ...
        try {
            bob = authenticationService
                    .register("bob1234@gmail.com", "qwerty");
            alice = authenticationService
                    .register("alice1980@gmail.com", "alicE1980");
        } catch (Exception e) {
            throw new RuntimeException("Can't register new users", e);
        }
