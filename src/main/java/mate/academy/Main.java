...
public class Main {
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        System.out.println("New order: " + orderService.completeOrder(userCart));
        System.out.println("Orders history of " + user.getEmail() + " -> "
                + orderService.getOrdersHistory(user));
        System.out.println("Cart of " + user.getEmail() + " after order -> "
