...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Order antonOrder = orderService.completeOrder(antonShoppingCart);
            System.out.println(antonOrder);
            Order antonNewOrder = orderService.completeOrder(antonShoppingCart);
            System.out.println(antonNewOrder);
            List<Order> ordersHistory = orderService.getOrdersHistory(anton);
