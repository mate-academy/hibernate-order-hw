...
public class Main {
    public static void main(String[] args) {
        ...
        User newUser;
        try {
            newUser = authenticationService.register("qwerty@gmail.com", "12345678");
        } catch (RegistrationException e) {
            throw new RuntimeException("Can't register new user", e);
        }
        try {
            System.out.println(authenticationService
                    .login("qwerty@gmail.com", "12345678"));
        } catch (AuthenticationException e) {
            throw new RuntimeException("Can't login with such email and password", e);
        }
