...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        anna.setEmail("anna.haithway@gmail.com");
        UserService userService = (UserService) injector
                .getInstance(UserService.class);
        userService.add(bob);
        userService.add(anna);

        Ticket terminator = new Ticket();
        terminator.setUser(bob);
        terminator.setMovieSession(tomorrowMovieSession);

        Ticket missionImpossible = new Ticket();
        missionImpossible.setUser(anna);
        missionImpossible.setMovieSession(yesterdayMovieSession);
