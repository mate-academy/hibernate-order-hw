...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (user != null) {
            ...
            System.out.println("\n=== Test 1: Create an order with an empty cart ===");
            ...
            System.out.println("\n=== Test 2: Add items and create an order ===");
            shoppingCartService.addSession(tomorrowMovieSession, user);
            shoppingCartService.addSession(yesterdayMovieSession, user);
            ...
            System.out.println("\n=== Test 5: Try creating an order after clearing the cart ===");
            ShoppingCart clearedCart = shoppingCartService.getByUser(user);
            Order clearedOrder = orderService.completeOrder(clearedCart);
            System.out.println("Order after clearing the cart: " + clearedOrder);
        }
    }
}
